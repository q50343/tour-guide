  ...
  <div class="header">
    ...
    <div :class="['drowdown df-around bdrs-xl',{ shadow: openCity },{ show: openCity }]">
      ...
      <div class="drowdown-mode df-around">
        <span v-for="item in Object.keys(modeLibs)" :key="item"
...
export default {
  ...
  setup(props) {
    ...
    const keyword = ref("");
    const regions = ref(['North', 'Central', 'South', 'East', 'Outer'])
